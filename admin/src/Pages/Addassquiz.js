    ...
    const handleSubmit= async  (e)=>{
     ...
     if(!Topic || !ClassN || !subject || !Question || !Date ){
        toast.error("Please fill all field");
                ...
                axios
                .post("http://localhost:5000/Insertassquiz",{
                    Topic,
                    ClassN,
                    subject,
                    Question,
...
<div className="col" id="heig">                        
                        ...
                        <p id="h11" className="d-flex justify-content-center">Add AssignmentQuiz</p>
</div> 
...
<form   id="inserted" encType="multipart/form-data"
    ...
    <div className="col">
       ...
       <select name="Topic" className="form-control" id='Topic' onChange={handleInputChange}>
    ...
    values &&   values.map((item)=>{
       ...
       <select name="ClassN" className="form-control" id='ClassN' onChange={handleInputChange}>
    ...
    values1 &&   values1.map((item)=>{
       ...
       <select name="subject" className="form-control" id='ClassN' onChange={handleInputChange}>
    ...
    values3 &&   values3.map((item)=>{
      ...
      <textarea type="text" name='Question'  onChange={handleInputChange}  className="form-control" 
