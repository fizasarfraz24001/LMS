...
const getCountry = async()=>{
    try{
        const response= await axios.get("http://localhost:5000/DisplayAdmin");
...
const deleteCategory=(Userid)=>{
    if(window.confirm("Are you sure you want to delete this record")){
     ...
     getCountry();
     setTimeout(()=>history("/ViewAdmin",{replace:true}),1000);
}) 
...
<p id="h11" class="d-flex justify-content-center">View USER</p>
</div>        </div>
