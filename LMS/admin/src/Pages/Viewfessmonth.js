...
const getCountry = async()=>{
    try{
        const response= await axios.get("http://localhost:5000/DisplayFeesChallan");
...
<p id="h11" class="d-flex justify-content-center">View Fees Record</p>
</div>        </div>
